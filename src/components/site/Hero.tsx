        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-primary-foreground/70 sm:text-lg">
              Audit-ready CREATE Act claim packs for BOI- and PEZA-registered companies — data
              collection, technical reports, and BIR-aligned coordination.
            </p>
          ...
          <div className="relative order-1 lg:order-2">
            ...
            <div className="absolute -bottom-6 -left-3 hidden w-[17rem] rounded-2xl border border-border/60 bg-card p-5 shadow-lift sm:-left-10 sm:block lg:-bottom-8">
